...
## Required parameters
parser.add_argument("--bert_model", default="squash_generation/question_answering/bert_large_qa_model", type=str, 
...
def generate_squash_answers():
    ...
    elif os.path.exists("./squash_generation/squash/generated_outputs/generated_answers/%s/predictions.json" % next_key):
        return
    else:
        print("Answering questions for %s" % next_key)

    predict_file = "./squash_generation/squash/generated_outputs/generated_questions/%s.json" % next_key
    output_dir = "./squash_generation/squash/generated_outputs/generated_answers/%s" % next_key
