...
from squash_generation.squash.squad_eval_utils import (
    f1_metric,
    exact_match_metric,
...
def filter_squash_qa():
    ...
    elif os.path.exists("./squash_generation/squash/generated_outputs/final/%s.json" % next_key):
        return
    else:
    ...
    try:
        with open('./squash_generation/squash/generated_outputs/generated_answers/%s/predictions.json' % next_key, 'r') as f:
    ...
    with open('./squash_generation/squash/generated_outputs/generated_questions/%s.json' % next_key, 'r') as f:
    ...
    with open('./squash_generation/squash/generated_outputs/final/%s.json' % next_key, 'w') as f:
