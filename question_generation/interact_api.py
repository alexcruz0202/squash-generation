...
from squash_generation.question_generation.train import SPECIAL_TOKENS
from squash_generation.question_generation.train import build_para_only_input_from_segments, build_qa_only_input_from_segments
from squash_generation.question_generation.dataloader import get_positional_dataset_from_file
...
parser.add_argument("--model_checkpoint", type=str, default="squash_generation/question_generation/gpt2_corefs_question_generation", help="Path, url or short name of the model")
...
def generate_squash_question():
    ...
    elif os.path.exists("./squash_generation/squash/generated_outputs/generated_questions/%s.json" % next_key):
        return
    else:
    ...
    args.filename = "./squash_generation/squash/generated_outputs/inputs/%s/input.pkl" % next_key

    with open("./squash_generation/squash/generated_outputs/inputs/%s/metadata.json" % next_key, "r") as f:
    ...
    with open("./squash_generation/squash/generated_outputs/generated_questions/%s.json" % next_key, "w") as f:
